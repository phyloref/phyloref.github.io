...
<figure>
  ...
  <figcaption>An example showing inconsistent taxonomies in OTT and VTO. *Scleropages formosus* is the preferred (valid) name in OTT and has four synonyms, whereas in VTO three of the synonyms are each considered a valid name. </figcaption>
</figure>
