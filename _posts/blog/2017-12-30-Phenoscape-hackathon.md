...
<figure>
  ...
  <figcaption>An example showing inconsistent taxonomies in OTT and VTO. Scleropages formosus is the preferred (valid) name in OTT and it has four synonyms, whereas in VTO three of the synonyms are considered valid names. </figcaption>
</figure>
