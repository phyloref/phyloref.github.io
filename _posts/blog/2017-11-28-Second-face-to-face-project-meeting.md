...
Most of the meeting was spent discussing the Phyloref specifications and the curation workflow. In particular, two hairy issues were discussed at length: the role and semantics of specifiers given as _qualifiers_ in nomenclatural phylogenetic clade definitions, and how best to model OTUs.
