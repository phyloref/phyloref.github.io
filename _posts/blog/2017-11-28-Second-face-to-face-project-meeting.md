...
![Discussion agenda items laid  on whiteboard: user stories, prototype, phyloref specifications and timeline]({{ site.url }}/images/2ndmeeting.whiteboard1.JPG)
...
Towards the end of the meeting, we did some planning for future activities. We planned out a visit for Guanyang and Gaurav to Duke in December. If selected for the Phenoscape workshop, Gaurav and Guanyang can combine the visit to Hilmar with the [^workshop] workshop. Additionally, we will be having our first advisory board meeting in early 2018.
